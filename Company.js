...
import Services from '../../services/Admin/Company';
import { validator } from '../../helpers/schemaValidator';
import { verifyToken } from '../../helpers/jwt';
import { approveInfo, rejectInfo, getEmployeesById, BrokerDetail, CompanyDetail } from '../../validators/Admin/Admin';
...
export default class Users {
    ...
    async CreateCompany(req, res) {
        try {
            ...
            console.log(body)
            const { isError, errors } = validator(body, CompanyDetail);
            if (isError) {
                return res.json({
                    status: 0,
                    message: errors,
            ...
            const detail = await this.services.createCompany(body);
            if (detail) {
                return res.json({
